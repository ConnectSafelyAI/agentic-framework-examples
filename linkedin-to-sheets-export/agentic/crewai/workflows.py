"""Workflows - Command execution handler for LinkedIn Export with CrewAI."""
...
class LinkedInExportWorkflows:
    ...
    def execute_command(self, command: str, context: Optional[str] = None) -> Dict[str, Any]:
        ...
        """
        return self.crew.execute(command, context)
    ...
    def search_and_export(
        ...
        search_result = self.crew.execute(search_cmd)
        ...
        export_result = self.crew.execute(
            export_cmd,
