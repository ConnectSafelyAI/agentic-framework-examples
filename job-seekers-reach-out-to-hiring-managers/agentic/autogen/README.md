...
autogen/
├── agents/
│   └── assistant.py          # LinkedInAssistant - Core AutoGen agent
...
5. **`tools/`**: Collection of ConnectSafely.ai API wrapper functions
...
- Previous job search results (stored in `last_search_results`)
